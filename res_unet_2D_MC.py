# -*- coding: utf-8 -*-
"""
Created on Thu Nov 17 12:23:48 2022
...
#%% create_res_unet_2D_MC
def create_res_unet_2D_MC(input_shape, num_classes, levels=3, convs_per_level=1, start_features=16, model_name = 'ResUNet2DMC'):
